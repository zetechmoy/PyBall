...
class Animation:
    ...
    def __init__(self, spImg, w, h, nbFrames, sp):
        ...
        self.spritesheet = pygame.transform.scale(self.spritesheet, (int(self.spritesheet.get_rect().width/2),int(self.spritesheet.get_rect().height/2)))
    ...
    def setSpritesheet(self, spImg):
        ...
        self.frames.clear()
        for i in range(0, self.nbFrames):
            self.frames.append(self.image_at(Rect(i * self.width, 0, self.width, self.height)))
